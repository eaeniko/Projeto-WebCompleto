		...
		<header>
			...
			<div id="menu-mobile" class="visible-xs">
				...
				<ul class="list-unstyled">
					...
					<li><a href="constrution">Tickets</a></li>
					<li><a href="constrution">News</a></li>
					<li><a href="constrution">Schedule</a></li>
				</ul>
			...
			<div class="header-black">
				...
				<!-- Bottom Mobile Search -->	<input type="search" id="input-search-mobile" class="visible-xs" placeholder="search..."> <!-- END -->
